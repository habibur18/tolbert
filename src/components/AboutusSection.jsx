      ...
      <div className="container mx-auto px-4 md:px-6">
        <div className="grid gap-6 lg:grid-cols-2 lg:gap-12 items-center">
          <div className="space-y-4">
            ...
            <h2 className="text-3xl font-bold tracking-tighter sm:text-4xl md:text-5xl">Your Trusted Garage Door Experts</h2>
            <p className="max-w-[600px] text-gray-500 md:text-lg/relaxed lg:text-base/relaxed xl:text-lg/relaxed dark:text-gray-400">With over 20 years of industry experience, Tolbert Garage Door is dedicated to delivering exceptional service, top-notch craftsmanship, and customer satisfaction throughout the Dallas-Fort Worth area.</p>
